...
exports.feedbackPost = async (req, res, next) => {
  ...
  switch (like) {
    ...
    //On récupère le post et on vérifie si le userId est dans usersLiked ou usersDisliked, et si il est dans l'un des deux, on retire le userId du tableau et on retire 1 au like ou au dislike
    case 0:
